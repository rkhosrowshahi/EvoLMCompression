...
ARMS = list(ALL_ARMS)
#: One-element list so a table builder can see the choice without a global
#: import dance; set alongside ARMS. Read by matched_table, which drops its
#: "Arm" column when there is only one arm to name.
SINGLE_ARM = [False]
